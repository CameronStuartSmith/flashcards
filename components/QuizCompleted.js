	...
	render() {
		...
		return (
			<View style={styles.container}>
				<Confetti ref={(node) => this._confettiView = node} confettiCount={50} />
				...
				<Animatable.View animation="fadeIn" delay={2000}>
					<Button style={styles.btn}>Start Over</Button>
					<Button style={styles.btn}>Go to Deck</Button>
				</Animatable.View>
			</View>
		);
	}
